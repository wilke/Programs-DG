...
do
	if [[ $file == *_R1_001.fastq.gz ]]
		...
		if [ -f ${Sampid}_R2_001.fastq.gz ] 
			...
			echo $Sampid
			python /mnt/g/MU_WW/Programs/derep.py $Sampid.all.fq $Sampid.collapsed.fa 1 &>>  ${Sampid}.derepinfo.txt
...
python3 /mnt/g/MU_WW/SAM_Refiner/SAM_Refiner.py -r /mnt/g/MU_WW/SARS2/SARS2.gb --wgs 1 --collect 0 --seq 1 --indel 0 --covar 0 --max_covar 2 --AAcentered 0 --nt_call 1 --min_count 1 --min_samp_abund 0 --ntabund 0 --ntcover 1 --AAreport 1 --mp 1 --chim_rm 0 --deconv 0
